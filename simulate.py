...
parser.add_argument('--rob-size', type=int, help="Number of reorder buffer entries (also controls number of physical registers). Default = 112.")
...
parser.add_argument('--ras-size', type=int, help="Number of return address stack entries (for branch predictor). Default = 8.")
parser.add_argument('--l1-data-size', type=int, help="Size in KB of L1 data cache. Default = 128.") #TODO: give guidance on what values work
...
print(power_output)
print("Results have been written to: power_usage."+pid)
